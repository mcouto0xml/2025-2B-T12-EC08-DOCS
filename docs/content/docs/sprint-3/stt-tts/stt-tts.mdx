...
<div style={{ textAlign: "center" }}>
  <sup>Figura 1: Interface do Laika AI Audio Assistant</sup>
</div>

![Interface do Laika](./laika-interface.png)
...
## 9. Interface do Usuário (Streamlit)
...
- **Background Chat - Usuário**: #2b313e (cinza escuro)
- **Background Chat - Bot**: #475063 (cinza médio)
- **Mensagens**: #ffffff (branco)
- **Status Success**: #00ff00 (verde)
- **Status Processing**: #ffaa00 (laranja)
- **Status Error**: #ff0000 (vermelho)
- **Container**: #f8f9fa (cinza claro)

#### Tipografia

- **Fonte Principal**: System default (Streamlit)
- **Tamanho de Fonte**: Padrão Streamlit
- **Peso**: Regular e Bold conforme contexto
...
**Divisão:**
- **Coluna 1 (70%)**: Chat e upload de áudio
- **Coluna 2 (30%)**: Status da pipeline e player

#### 3. Área de Chat

Exibe histórico completo da conversa.

**Função: `display_chat_message(message, is_user=True)`**

**Características:**
- Mensagens do usuário alinhadas à direita
- Mensagens do bot alinhadas à esquerda
- Avatar diferenciado para usuário e bot
...
- Tooltip com formatos suportados

#### 5. Status da Pipeline

**Função: `display_pipeline_status()`**

Mostra o progresso em tempo real de cada etapa:
...
#### 6. Player de Resposta

Reproduz o áudio da última resposta do bot.
...
**Processar Áudio:**
```python
st.button("Processar Áudio", type="primary")
```

**Limpar Chat:**
```python
st.button("Limpar Chat")
```
...
if sucesso:
    ...
    print(f"Laika respondeu: {resposta}")
