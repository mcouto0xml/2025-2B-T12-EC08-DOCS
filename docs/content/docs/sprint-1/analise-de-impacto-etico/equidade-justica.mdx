...
<Callout title="Nota Adicional" type="tip">   A análise de equidade também deve considerar deficiências cognitivas. Para estes visitantes, recomenda-se o uso de interfaces radicalmente simplificadas, linguagem literal (evitando ambiguidades) e um comportamento previsível do robô para evitar sobrecarga sensorial. </Callout>
...
<Callout title="Risco Crítico: Exclusão Simbólica" type="danger"> O sistema de ASR, treinado majoritariamente com o "padrão paulistano", pode falhar repetidamente ao processar sotaques nordestinos, nortistas, do interior rural, ou de falantes não-nativos e adolescentes (gírias). Cada falha ("Desculpe, não entendi") não é meramente um inconveniente técnico, mas uma comunicação simbólica de "você não pertence aqui". Isso pode desestimular ativamente jovens de backgrounds marginalizados de se engajarem com a tecnologia e com o próprio Inteli. </Callout>