...
BOSTON DYNAMICS. *Spot Robot*. Disponível em: <https://www.bostondynamics.com/spot>. Acesso em: 24 out. 2025.

SOFTBANK ROBOTICS. *Pepper Robot*. Disponível em: <https://www.softbankrobotics.com/aboutus/>. Acesso em: 24 out. 2025.
