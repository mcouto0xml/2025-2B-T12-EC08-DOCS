...
&emsp;O gráfico a seguir apresenta uma comparação visual dos atributos do nosso projeto em relação aos concorrentes. Cada linha representa um concorrente, permitindo observar rapidamente os pontos fortes e oportunidades de melhoria.
...
&emsp;A análise ERAC permite identificar ações estratégicas para diferenciar nosso robô em relação aos concorrentes e gerar valor para os visitantes.
...
&emsp;A análise da Matriz Oceano Azul demonstrou que nosso robô se diferencia principalmente pelo foco em experiência, engajamento, acessibilidade e coleta estratégica de dados.  
