...
- O **robô e o sistema de controle** estejam conectados ao **Wi-Fi específico do projeto ()**, previamente configurado.
...
- **Não é permitido movimentar fisicamente o robô** caso sua atividade seja interrompida.

> **Importante:**  
> Caso o robô seja movido manualmente após uma interrupção, a **continuidade do tour é impossibilitada**, pois o sistema perde a referência do ponto exato onde a atividade foi pausada.
...
1. Não movimentar o robô manualmente.
2. Avaliar visualmente possíveis danos.
3. Verificar diagnósticos no aplicativo/sistema.
4. Registrar o ocorrido antes de qualquer nova tentativa de operação.
