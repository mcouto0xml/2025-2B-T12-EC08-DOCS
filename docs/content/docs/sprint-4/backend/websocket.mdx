...
description: Sistema responsável pela comunicação em tempo real entre robô, backend e frontend do projeto Tour Inteli, incluindo chat com visitantes e controle de checkpoints.
---
...
&emsp;A comunicação ocorre em tempo real via WebSockets, centralizada pelo backend implementado em Rust com Actix-Web.

## **2. Visão Geral da Arquitetura**

&emsp;O sistema utiliza três canais de WebSockets:
...
&emsp;O _Broadcast Server_ é o "cérebro" do sistema de comunicação de chat.
...
&emsp;Cliente WebSocket que conecta ao servidor Python do robô para receber eventos de navegação e enviar comandos de controle.
...
&emsp;Servidor WebSocket que aceita conexões do frontend para enviar eventos de checkpoint em tempo real e receber comandos de controle.
