---
title: Documentação do Chatbot Inteli
...
&emsp;O Chatbot Inteli é um assistente virtual especializado desenvolvido para responder perguntas sobre o Instituto de Tecnologia e Liderança. O sistema utiliza a tecnologia Google Generative AI (Gemini) para processar consultas e fornecer respostas precisas baseadas em documentos oficiais do instituto.
...
Integração com Google Generative AI (Gemini 2.0 Flash) para processamento de linguagem natural e geração de respostas contextualizadas.
...
O sistema processa automaticamente documentos PDF para criar uma base de conhecimento. O processo inclui:
...
2. **Edital-Processo-Seletivo-Inteli_-Graduacao-2026_AJUSTADO.pdf**: Edital oficial do processo seletivo
...
#### 5. Input e Botão de Envio

Área de digitação e envio de mensagens.

**Características**:
*   Input com borda que muda para vermelho no foco
*   Botão vermelho gradiente
*   Enter para enviar
...
#### Desktop (> 900px)
*   Container com largura máxima de 900px
*   Mensagens ocupam até 70% da largura
*   Espaçamento generoso

#### Tablet (600px - 900px)
*   Container adapta-se à largura disponível
*   Mensagens mantêm proporção
*   Touch targets otimizados

#### Mobile (< 600px)
*   Layout vertical completo
*   Mensagens podem ocupar até 85% da largura
...
/* Cores principais */
#2B2D42  /* Azul escuro */
#E63946  /* Vermelho Inteli */
```

#### Layout

Modifique classes CSS para ajustar:

*   Tamanho do container (`.chat-container`)
*   Largura de mensagens (`.message-content`)
