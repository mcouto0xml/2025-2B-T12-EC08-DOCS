...
## 4. Tela Dashboard e Controle de Usuário
Esta tela é uma extensão da tela de Dashboard e permitirá ao Staff realizar o controle e acompanhamento dos visitantes do tour.

*   **Propósito:** Permitir que o Staff mantenha as informações do Inteli atualizadas para o modelo de IA do cão robô e acompanhe as informações dos visitantes.
*   **Elementos-Chave:**
    *   **Seção Documentos:** Localizada no centro esquerdo da tela, permite ao Staff remover ou adicionar informações sobre o Inteli, mantendo o sistema sempre atualizado.
    *   **Seção de Roteiro:** Localizada no centro direito da tela, permite ao Staff alterar informações sobre o roteiro, caso seja necessário.
    *   **Seção de Controle de Usuário:** Localizada no centro direito da tela, abaixo da Seção de Roteiro, permite ao Staff visualizar quem está visitando o Inteli e remover visitantes, se preciso.
    *   **Navbar:** Localizada à esquerda da página, permite ao usuário navegar até as outras telas do site.

<p style={{ textAlign: "center" }}>Figura 4 - Dashboard e Controle de Usuário</p>

![Tela - Dashboard e Controle de Usuário](./imgs/wireframe-site-staff-controle-usuario.png)
...
### 4. Acompanhar e Controlar Visitantes
Por fim, o Staff utiliza a **Tela 4** (Dashboard e Controle de Usuário) para acompanhar quem está realizando o tour, verificar status e, se necessário, remover algum visitante.
</Steps>
