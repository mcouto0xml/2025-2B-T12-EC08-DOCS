...
<p style={{ textAlign: "center" }}>Figura 4 - Tutorial Botão de Emergência</p>
...
<p style={{ textAlign: "center" }}>Figura 8 - Tela de Chat - Envio de dúvida</p>
...
<p style={{ textAlign: "center" }}>Figura 10 - Tela de Prosseguir</p>
...
<p style={{ textAlign: "center" }}>Figura 11 - Tela de Emergência</p>
...
<p style={{ textAlign: "center" }}>Figura 11 - Tela do Mapa</p>
